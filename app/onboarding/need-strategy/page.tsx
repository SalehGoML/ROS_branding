    ...
    <main style={{
      ...
      <div style={{ width: '100%', maxWidth: 560, position: 'relative', zIndex: 2 }}>
        ...
        <div style={{
          ...
          <p style={{
            fontSize: '.88rem', color: 'var(--c-text-muted)',
            lineHeight: 1.8, marginBottom: '2rem',
          }}>
            سرویس ما بر اساس ویژگی‌های پایه برند مانند شخصیت، ارزش‌ها و لحن
            تحلیل انجام می‌دهد. اگر این ویژگی‌ها در قالب یک سند مشخص نشده
            باشند، نمی‌توان تحلیل دقیقی ارائه کرد.
          </p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: '1.05rem', fontWeight: 700, marginBottom: '.5rem' }}>
              ...
              <p style={{
                ...
                با تکمیل یک فرم هدفمند، سیستم ROS برای برند شما
                یک سند اولیه طراحی می‌کند — سریع، دقیق و داده‌محور.
              </p>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '.82rem', color: 'rgba(255,255,255,.7)' }}>
                  ⏱ حدود ۱۵ دقیقه
                </div>
                <Link href="/onboarding/create-brand-profile" style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                color: 'var(--c-text)', marginBottom: '.4rem',
              }}>
                صرف‌نظر موقت
              </h3>
              <p style={{
                fontSize: '.83rem', color: 'var(--c-text-muted)',
                lineHeight: 1.7, marginBottom: '1.25rem',
              }}>
                در حال حاضر نمی‌خواهید سند برند بسازید؟ همچنان می‌توانید
                وارد پنل شوید، اما امکانات تحلیل تا ساخت سند برند
                غیرفعال خواهند بود.
              </p>
        ...
        <button
          ...
          style={{
            ...
            fontSize: '.8rem', color: 'var(--c-text-light)',
