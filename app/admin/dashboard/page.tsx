...
const alerts = [
  {
    id: 1,
    type: "warning",
    text: "۳ تحلیل در صف انتظار بیش از ۱۰ دقیقه",
    href: "/admin/analysis",
  },
  {
    id: 2,
    type: "error",
    text: "تراکنش مشکوک شناسایی شد — کاربر #۱۰۴۲",
    href: "/admin/billing",
  },
  {
    id: 3,
    type: "info",
    text: "۸ درخواست پشتیبانی بی‌پاسخ",
    href: "/admin/support",
  },
  {
    id: 4,
    type: "warning",
    text: "۲ سند برند ناقص در انتظار بررسی",
    ...
    <div style={{ padding: "2rem", maxWidth: 1200, margin: "0 auto" }}>
            ...
            .map((alert) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span style={{ color: s.color, fontSize: ".85rem" }}>
                      {s.icon}
                    </span>
                    <Link
                      href={alert.href}
      ...
      >
        ...
        >
          ...
          <Link
            href="/admin/users"
            style={{ fontSize: ".78rem", color: "#4A8C7C" }}
          >
            مشاهده همه ←
          </Link>
        </div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr style={{ background: "rgba(255,255,255,.02)" }}>
                {["نام", "برند", "پلن", "وضعیت", "آخرین فعالیت", "عملیات"].map(
                  (h) => (
                    <th
                      key={h}
                      style={{
